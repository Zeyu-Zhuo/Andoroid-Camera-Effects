...
public class CameraEffectsViewRender implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String vertex = Utils.loadStringFromAssets(context,"vertex.vert");
        String fragment =Utils.loadStringFromAssets(context,"fragment.frag");
